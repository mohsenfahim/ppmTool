...
import com.mohsenfahim.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id,Principal principal){
        ProjectTask projectTask = projectTaskService.findPTBySequence(backlog_id, pt_id, principal.getName());
